    ...
    return ( 
      <TouchableWithoutFeedback onPress={() => this._onPress()}>
        <Animatable.View ref="view" 
         style={{ paddingVertical :10,  paddingHorizontal: 20, backgroundColor: this.state.status ? this.props.onColor : "white", borderRadius:20 , borderColor:'gray' , borderWidth:1}}>
